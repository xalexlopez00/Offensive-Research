...
Abre una terminal en la carpeta master/ y lanza el centro de control con el comando:
python receptor.py
...
Envía este comando desde la terminal del receptor:
...
master/: Consola interactiva C2 (receptor).
