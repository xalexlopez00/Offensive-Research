...
El error fue que los bloques de código (los que tienen ` ``` `) estaban pegados al texto de arriba. En Markdown, **siempre** debe haber una línea totalmente vacía entre un párrafo y una lista o un bloque de código.

**¿Quieres que te lo pase todo en un solo bloque (toda la página) para que solo hagas un clic y ya?** Si n
