...
Carpeta server/: Panel de control web y base de datos.

Carpeta client/: Ejecución de comandos en el objetivo (agente).

Carpeta master/: Consola interactiva C2 (Command & Control).
